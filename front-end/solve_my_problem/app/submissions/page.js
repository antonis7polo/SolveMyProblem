                        ...
                        <tbody>
                            {filteredSubmissions.map((submission) => (
                                <tr key={submission._id}>
                                    ...
                                    <td>
                                        <button onClick={() => handleView(submission._id, submission.userId)} className={`${styles.button} ${styles.viewButton}`}>View</button>
                                        {submission.status === 'completed' && (
                                            <button onClick={() => handleViewResults(submission._id, submission.userId)} className={`${styles.button} ${styles.resultsButton}`}>View Results</button>
                                        )}
                                        <button onClick={() => handleDelete(submission._id)} className={`${styles.button} ${styles.deleteButton}`}>Delete</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
